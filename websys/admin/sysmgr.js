...
main.createUserFilterWindow = function(fieldName) {
  ...
  html += '  <tr>';
  html += '    <td>Search</td>';
  html += '    <td><input type="text" id="user-filter-keyword" spellcheck="false" style="width:calc(100% - 60px);" oninput="main.onUserFiltering();"><button style="margin-left:8px;" onclick="main.setUserFiltering();">Filter</button></td>';
  html += '  </tr>';
  html += '</table>';
  html += '</div>';
...
main.openUserInfoEditorWindow = function(mode, uid) {
  ...
  html += '    <td><input type="text" id="uid" spellcheck="false" style="width:100%;" onblur="main.onUidBlur();"></td>';
  html += '  </tr>';
  html += '  <tr>';
  ...
  html += '    <td><input type="text" id="groups" spellcheck="false" style="width:100%;"></td>';
  html += '  </tr>';
  html += '  <tr>';
  html += '    <td class="user-edit-field-name">Privileges</td>';
  html += '    <td><input type="text" id="privs" spellcheck="false" style="width:100%;"></td>';
  html += '  </tr>';
  html += '  <tr>';
  html += '    <td class="user-edit-field-name">Info1</td>';
  html += '    <td><input type="text" id="info1" spellcheck="false" style="width:100%;"></td>';
  html += '  </tr>';
  html += '  <tr>';
  html += '    <td class="user-edit-field-name">Info2</td>';
  html += '    <td><input type="text" id="info2" spellcheck="false" style="width:100%;"></td>';
  html += '  </tr>';
  html += '  <tr>';
  html += '    <td class="user-edit-field-name">Info3</td>';
  html += '    <td><input type="text" id="info3" spellcheck="false" style="width:100%;"></td>';
  html += '  </tr>';
  html += '  <tr>';
...
main.openGroupInfoEditorWindow = function(mode, gid) {
  ...
  html += '      <input type="text" id="gid" spellcheck="false" style="width:100%;">';
  html += '    </td>';
  html += '  </tr>';
  html += '  <tr>';
  html += '    <td>Name</td>';
  html += '    <td><input type="text" id="group-name" spellcheck="false" style="width:100%;"></td>';
  html += '  </tr>';
  html += '  <tr>';
  html += '    <td>Privileges</td>';
  html += '    <td><input type="text" id="group-privs" spellcheck="false" style="width:100%;"></td>';
  html += '  </tr>';
  html += '  <tr>';
